...
public class KasirBeta2 {
    ...
    private static void loginAdmin(Scanner input) {
        ...
        while (true) {
            ...
            String tanggalMasuk = inputAdm.nextLine();
            biodataPasien[idx][6] = tanggalMasuk;

            System.out.print("=> Tanggal Keluar (dd/MM/yyyy): ");
            String tanggalKeluar = inputAdm.nextLine();
            biodataPasien[idx][7] = tanggalKeluar;
                ...
                case 1:
                    ...
                    while (idx < biodataPasien.length) {
                        if (biodataPasien[idx][0] == null) {
                            String[][] biodataPasien = new String[10][8];
